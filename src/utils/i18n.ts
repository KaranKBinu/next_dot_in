...
export const TRANSLATIONS: Record<Locale, TranslationDictionary> = {
    en: {
        ...
        cartEmptySub: "Browse our collections and claim unique vintage pieces.",
        cartReservedWarning: "These 1-of-1 items are reserved for you.",
    ...
    hi: {
        ...
        cartEmptySub: "हमारे संग्रह देखें और अद्वितीय विंटेज टुकड़े प्राप्त करें।",
        cartReservedWarning: "ये अनोखे कपड़े आपके लिए आरक्षित हैं।",
    ...
    ml: {
        ...
        cartEmptySub: "ഞങ്ങളുടെ ഉൽപ്പന്നങ്ങൾ കണ്ട് മികച്ചവ തിരഞ്ഞെടുക്കൂ.",
        cartReservedWarning: "ഈ അപൂർവ്വ വസ്ത്രങ്ങൾ നിങ്ങൾക്കായി മാറ്റിവെച്ചിരിക്കുന്നു.",
